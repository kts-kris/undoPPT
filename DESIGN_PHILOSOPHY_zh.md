...
### 原则八：终局决策促成与立体客观对标 (Decision-Ready Closing & Rigorous Benchmarking)
面向管理层或决策者的汇报，其唯一合法目的绝不是“展示作者有多辛苦”，而是**“促成高质量、低摩擦的管理决策”**：
- **终局请领导决策事项 (Decision-Ready Ask)**：汇报收尾必须由信息堆砌切换为结构化决策请求（选项比选矩阵、推荐方案、待批决议清单）。在 HTML 中支持现场勾选决议项，锁定管理层拍板意向；
- **三维立体客观对标 (3-Way Reference Frame)**：严禁“我方全赢、友商全输”的虚假狂妄对比。外部对标必须构建“行业领头羊标杆 vs 直接同态竞品 vs 维持现状成本”立体参照系，客观呈现自身妥协、迁移摩擦成本与适用边界，捍卫公信力。

### 原则九：战功净增量归因与组织思考厚度 (Authentic Career Attribution & Multi-Scenario Depth)
在晋升述职、成果复盘与企业各类专题汇报中，汇报者必须用事实与深度打消评审心理防线：
- **剥离大盘红利，突出净增量**：严禁将部门大盘或自然增长包装为个人功劳。采用严格的 STAR 深度归因，明确交代“因我的关键解法所带来的净产出增量”；
- **从事务执行跃迁至方法论沉淀**：从单次完成业务，到提炼出一套跨团队复用的架构规范、SOP 或技术标准，展现认知溢出与组织赋能；
- **穷尽 12 大场景专用心智**：深入立项答辩、年度战略、QBR 复盘、跨部门拉通、人头预算评审、RFC 评审、故障复盘、GTM 发布、大客户竞标、晋升述职、技术内训、全员大会 12 大场景的 Job-to-be-Done，拒绝千篇一律的模板套用。
